...
INSERT INTO SpotifyClone.planos (tipo, valores) VALUES
('gratuito', '0.00'),
('universitario', '5.99'),
('pessoal', '6.99'),
('familiar', '7.99');
...
INSERT INTO SpotifyClone.albums (nome, artista_id, ano_lancamento) VALUES
('Envious', 1, '1990'),
('Exuberant', 1, '1993'),
...
INSERT INTO SpotifyClone.musicas (nome, album_id, duracao_segundos) VALUES
('Soul For Us', 1, '200'),
('Reflections Of Magic', 1, '163'),
('Dance With Her Own', 1, '113'),
...
INSERT INTO SpotifyClone.usuario_segue_artista (usuario_id, artista_id) VALUES
(1, 1),
(1, 4),
(1, 3),
(2,	1),
...
INSERT INTO SpotifyClone.historico_de_reproducoes (usuario_id, musica_id, data_reproducao) VALUES
...
(7, 6, '2018-05-09 22:30:49'),
(7, 5, '2020-07-27 12:52:58'),
(7, 12, '2018-01-16 18:40:43'),
...
(9, 9, '2021-03-14 06:14:26'),
(9, 10, '2020-04-01 03:36:00'),
(10, 21, '2017-02-06 08:21:34'),
(10, 22, '2017-12-04 05:33:43'),
(10, 13, '2017-07-27 05:24:49'),
(10, 14, '2017-12-25 01:03:57');
